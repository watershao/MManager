package com.qrobot.mm.activate;
...
//		putData(AppCode.App_AvatorCode, "1608847893");
	 ...
	 * @return
	 */
	public boolean boundRobCodeByQQ(String qq, String robCode){
		putData(AppCode.App_QQCode, qq);
		putData(AppCode.App_RobCode, robCode);
		String json = getJson(AppCode.App_Bind_QQ);
		if (json.isEmpty()) {
			return false;
		}

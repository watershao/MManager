...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.qrobot.mm.clock.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.qrobot.mm.clock.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.qrobot.mm.clock.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.qrobot.mm.clock.ALARM_DISMISS";
    ...
    private static ContentValues createContentValues(Alarm alarm) {
        ...
        values.put(Alarm.Columns.NUMBER, alarm.number);
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(ClockFragment.PREFERENCES, 0);
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        if (true) {
            Log.v("Alarms", "** setAlert id " + alarm.id + " atTime " + atTimeInMillis);
        }

...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.qrobot.mm.clock", "alarm", ALARMS);
        sURLMatcher.addURI("com.qrobot.mm.clock", "alarm/#", ALARMS_ID);
        
        sURLMatcher.addURI("com.qrobot.mm.clock", "ring", RINGS);
        sURLMatcher.addURI("com.qrobot.mm.clock", "ring/#", RINGS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    ...
                    "VALUES ";
            db.execSQL(insertMe + "(8, 30, 31, 0, 0, 1, '', '002.mp3',1,5);");
            ...
            db.execSQL(insertRing + "('006.mp3','006.mp3');");
        }

package com.qrobot.mm.clock;

import com.qrobot.mm.R;
import com.qrobot.mm.util.ToastMaster;
...
//    private AlarmPreference mAlarmPref;
    private RingPreference mRingPref;
    private CheckBoxPreference mVibratePref;
    private RepeatPreference mRepeatPref;
    
    private AlarmNumberPreference mNumberPreference;
    private AlarmIntervalPreference mIntervalPreference;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.clock_set_alarm);
...
//        mAlarmPref.setOnPreferenceChangeListener(this);
        mRingPref = (RingPreference)findPreference("alarm");
        mRingPref.setOnPreferenceChangeListener(this);
        ...
        mNumberPreference = (AlarmNumberPreference)findPreference("number");
        mNumberPreference.setOnPreferenceChangeListener(this);
        mIntervalPreference = (AlarmIntervalPreference)findPreference("interval");
        mIntervalPreference.setOnPreferenceChangeListener(this);

        Intent i = getIntent();
        mId = i.getIntExtra(Alarms.ALARM_ID, -1);
        if (true) {
            Log.v("SetAlarm", "In SetAlarm, alarm id = " + mId);
        }
...
//        mAlarmPref.setAlert(alarm.alert);
        mRingPref.setRing(alarm.alert.toString());
//        Log.d("SetAlarm", "alert:"+alarm.alert.toString());
        
        mNumberPreference.setAlarmNumber(alarm.number);
        mIntervalPreference.setAlarmInterval(alarm.interval);
        updateTime();
    }
...
//        alarm.alert = mAlarmPref.getAlert();
        alarm.alert = mRingPref.getRing();
        
//        Log.d("SetAlarm", "alert1:"+alarm.alert.toString());
        alarm.number = mNumberPreference.getAlarmNumber();
        alarm.interval = mIntervalPreference.getAlarmInterval();

...
import com.qrobot.mm.clock.Alarm.DaysOfWeek;
...
import com.qrobot.mm.reminder.Reminder;
import com.qrobot.mm.reminder.Reminders;
...
/*	
	...
	public ClockSync(Context context, NettyClientManager clientManager){
		...
		mClientManager.setErrorDataListener(errorDataListener);
...
//		return null;
	...
	private ErrorDataListener errorDataListener = new ErrorDataListener() {
		...
		public void OnErrorDataListener(int errorCode, byte[] msg) {
			...
			if (errorCode == 2) {
				Toast.makeText(mContext, R.string.prompt_Q_offline_updata, Toast.LENGTH_LONG).show();
			}
		}
	};
}

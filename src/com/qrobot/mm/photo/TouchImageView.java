...
public class TouchImageView extends ImageView {
    ...
    public TouchImageView(Activity activity,String pathName) {
        super(activity);
//        gintama = BitmapFactory.decodeResource(getResources(), R.drawable.bg);
 
//        gintama = BitmapFactory.decodeFile("/storage/sdcard0/wandoujia/image/71313710.jpg");
        gintama = BitmapFactory.decodeFile(pathName);
...
//                matrixCheck = matrixCheck();
    ...
    private boolean matrixCheck() {
        ...
        Log.d("TouchImage", "width:"+width+",widthScreen:"+widthScreen);
        Log.d("TouchImage", "x1:"+x1+",x2:"+x2+",x3:"+x3+",x4:"+x4+",y1:"+y1
        		+",y2:"+y2+",y3:"+y3+",y4:"+y4);
        // 缩放比率判断
        if (width < widthScreen / 3 || width > widthScreen * 3) {
//        if (width > widthScreen * 3) {
        	Log.d("TouchImage", "suobilv");
            return true;
        }
        // 出界判断
